...
\033[1;32m----------------------------------------------
➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃ UPENDRA ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤
❣︎[𖣘]☔︎CREATED BY   :  UPENDRA-DON
❣︎[𖣘]☔︎ FB NAME     : UPENDRA-DON
❣︎[𖣘]☔︎ON GITHUB    :  UPENDRA
❣︎[𖣘]☔︎TOOL STATUS  :  FREE
❣︎[𖣘]☔︎TOOL VERSION :  1.0                           
➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃ UPENDRA⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤       
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[UPENDRA]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
